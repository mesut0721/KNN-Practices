...
# (2) makine öğrenmesi modelinnin seçilmesi
...
knn.fit(X_train,y_train) #fit fonksiyonu vermizi (samples+ target) kullanarak knn algoritmasını eğitir
...
plt.title("K deperine göre doğruluk")
plt.xlabel("K değeri")
plt.ylabel("Doğruluk")
plt.xticks(k_values)
plt.grid(True)
